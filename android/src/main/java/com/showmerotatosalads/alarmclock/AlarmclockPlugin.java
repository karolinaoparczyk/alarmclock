...
public class AlarmclockPlugin implements MethodCallHandler {
    ...
    public boolean startAlarmClockActivity(MethodCall call) {
        try {
            ...
            boolean monday = args.getBoolean(4);
            boolean tuesday = args.getBoolean(5);
            boolean wednesday = args.getBoolean(6);
            boolean thursday = args.getBoolean(7);
            boolean friday = args.getBoolean(8);
            boolean saturday = args.getBoolean(9);
            boolean sunday = args.getBoolean(10);
